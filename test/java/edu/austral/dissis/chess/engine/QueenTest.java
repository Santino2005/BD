...
public class QueenTest {
  ...
  public void cantMoveTest() {
    ...
    Position initial = new Position(1, 4);
  ...
  public void canMoveTest() {
    ...
    Position initial = new Position(1, 4);
    Position finalPos = new Position(4, 1);

    Position initial2 = new Position(8, 4);
    Position finalPos2 = new Position(1, 4);
  ...
  public void getColor() {
    ...
    Position initial2 = new Position(8, 4);
    Position finalPos2 = new Position(5, 4);
